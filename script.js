function convertTemperature() {
    ...
    if(unit === 'Celsius') {
        ...
        convertedTemperature = (inputTemperature + 273 );
        document.getElementById("result").textContent =`${inputTemperature} degrees Kelvin = ${convertedTemperature} degrees Celsius .  `
